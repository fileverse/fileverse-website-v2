...
const Why = () => {
  ...
  return (
    <div className="bg-yellow h-[100vh]">
      ...
      <div
        className={` py-4 h-[85vh] w-full flex flex-col justify-center ${
          isMediaMax1025px ? 'px-4' : 'px-40'
        }`}
      >
        <div
          className={`rounded-lg h-full  py-8 bg-white overflow-auto styled-scrollbar ${
            isMediaMax1025px ? 'px-6' : 'px-20'
          }`}
        >
          <h1 className="font-bold mb-4 text-lg">About Fileverse</h1>
          <div className="mb-6 text-gray-600">
            File-sharing and access management is one of the most important and
            basic activities on the Internet.
            <br />
            <br />
            We do it to share our ideas, our work, our memes. We do it to
            collaborate with each other online, to create an identity or simply
            to communicate with others.
            <br />
            <br />
            Now is the time to do it with a Web3 tech stack. Now is the time to
            use Fileverse.
            <br />
            <br />
          ...
          <div className="mb-6 text-gray-600">
            ...
            <br />
            Today, consumer file-storage, sharing, and access management happens
            via <b>centralised services (Web2)</b>.
            <br />
            <br />
            ...
            <ul className="list-disc">
              <li className="ml-8">
                ...
                identity / personal data leakage, censorship and opt-in (if any
                at all) content encryption.
              </li>
              <li className="ml-8">
          ...
          <div className="mb-6 text-gray-600">
            <br />
            Fileverse solves the main pain points of Web2 file sharing services,
            while also innovating in access rights management and content
            encryption. We believe that now is the time to share information by
            using a Web3 tech stack.
            <br />
            <br />
            ...
            networks (like IPFS) and encryption enabled via crypto wallets’ (eg.
            MetaMask) private key signatures.
            <br />
            <br />
            ...
            other peer-to-peer storage networks, Ethereum/EVMs, Layer 2 chains,
            and wallet-enabled file encryption, into one intuitive &
          ...
          <div className="mb-6 text-gray-600">
            ...
            <br />
            <br />
            Vitalik and many others in the space have been calling for this for
            a long time, but it has only now become possible to develop DApps
            ready for mass usage thanks to recent L2 developments, ZK tech
            advancements, the growing user-base of popular wallets like
          ...
          <div className="mb-6 text-gray-600">
            ...
            decentralised file-sharing tool. An app with a low barrier to entry
            for one of the most important activities on the internet: file
            ...
            because of its simplicity and usefulness, without cutting corners on
            decentralization!
            <br />
            <br />
            Our research and product development efforts are driven by two core
            objectives:
            <br />
            <br />
            <ul className="list-disc">
              ...
              <li className="ml-8">
                Educate & onboard the next big wave of new users to Web3 without
            ...
            - @Alchemy And MANY more individual cryptographers & developers who
            built several components and tools at the heart of Fileverse 🙌
          </div>
        </div>
      </div>
      <div className="bg-yellow h-[5vh] flex items-center justify-center p-4">
